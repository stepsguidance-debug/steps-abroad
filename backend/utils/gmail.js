/**
 * Strict @gmail.com-only validation (same rules as frontend/lib/gmail.ts).
 */
function segmentError(part, minLen, maxLen, lengthLabel) {
...
function validateStrictGmail(email) {
...
module.exports = { validateStrictGmail };
